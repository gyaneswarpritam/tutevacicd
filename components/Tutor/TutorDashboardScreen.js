...
import FabCreate from '../common/FabCreate';
...
const TutorDashboardScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
          ...
          <Row>
            ...
            <Col size={25}>
              <View style={{
                ...
                {/* <Icon name="user-circle-o" size={30} color='#222222' style={{ position: 'absolute', zIndex: 99 }} /> */}
              </View>
            </Col>
          </Row>
        </Grid>
          ...
          {isLoading ? (
            ...
            <Grid>
              {courses && courses.length > 0 ?
                <TitleHeader title={"Up Next"} onPress={() => { navigation.navigate('MyClass') }} />
                : <></>}
              <Row>
                <Col>
                  {courses && courses.length > 0 ?
                    ...
                    <View
                      ...
                      <View style={{ alignItems: 'center', marginVertical: 20 }}>
                        <SubmitButton title="CREATE NEW COURSE NOW" onPress={() => navigation.navigate('CreateClass')} buttonWidth={198}
              ...
              <TitleHeader title={"My Courses"} onPress={() => { navigation.navigate('MyClass') }} />
              <Row>
                <Col>
                  {courses && courses.length > 0 ?
                    <FlatList nestedScrollEnabled
      ...
      <FabCreate onPress={() => navigation.navigate("CreateClass")} />
    </SafeAreaView>
  );
};
